...
const ownerNumber = ['94785893445','94783162197']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("𝚀𝚄𝙴𝙴𝙽-𝙼𝙳=")[1];
...
console.log("Connecting ᴏꜰꜰɪᴄɪᴀʟ Qᴜᴇᴇɴ x ᴍᴅ Bot.....🚀");
...
console.log('ᴏꜰꜰɪᴄɪᴀʟ Qᴜᴇᴇɴ x ᴍᴅ Bot connected to whatsapp ✅')

let up = `
*𝐂𝐎𝐍𝐍𝐄𝐂𝐓 𝐒𝐔𝐂𝐂𝐔𝐒𝐅𝐔𝐋𝐋 𝐘𝐎𝐔𝐑 𝐖𝐇𝐀𝐓𝐒𝐀𝐏 𝐁𝐎𝐓* 😮⃝৫⃟➤᭄᭄̊̊̊̊࿓࿔

𝚁𝙴𝙿𝙾 𝚂𝙸𝚃𝙴= ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ⚓

_චැනල් එකෙන් ඔයලට ඔනැම දෙයක් දැනගන්න පුලුවන් චැනල් එකට join වෙලා ඉන්න⚓_

𝙲𝙷𝙰𝙽𝙴𝙻 𝙻𝙸𝙽𝙺= https://whatsapp.com/channel/0029VbAXsYXIiRozOhimJZ0Z

*╭𝐏ᴏᴡᴇʀᴅ 𝐁ʏ 𝐐ᴜᴇᴇɴ 𝐗 𝐌ᴅ🧚❤️⃝➤⃟̱̱̱̱̄̄̄̄😢

*𝐎𝐖𝐍𝐄𝐑=* https://wa.me/94785893445?text=🚀ꜱᴀɴɴᴜ_ʙʙʜ
`;

conn.sendMessage(conn.user.id,{ image: { url: `https://cdn.vioo.my.id/v/ULfJIE.png` }, caption: up })
...
await conn.sendMessage(from, { text: "*Another Bot's message Detected*\n❗*Removed By ᴏꜰꜰɪᴄɪᴀʟ Qᴜᴇᴇɴ x ᴍᴅ* ❗\nAnti Bot System on..." })
if ( config.ANTI_BOT == "true" && isBotAdmins ) {
await conn.sendMessage(from, { delete: mek.key })
await conn.groupParticipantsUpdate(from,[sender], 'remove')
  }}
...
//================ownerreact==============
if(senderNumber.includes("94785893445")){
if(isReact) return
m.react("🚀")
}
...
app.get("/", (req, res) => {
res.send("ᴏꜰꜰɪᴄɪᴀʟ Qᴜᴇᴇɴ x ᴍᴅ Bot,started✅");
});
